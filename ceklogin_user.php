...
$username = $_POST['username'];//mengambil isian username dan username dari form
$password = $_POST['password'];//mengambil isian username dan password dari form

//query untuk mengambil data user dari database sesuai dengan username dan password inputan form
