...
if($tipe_file == "image/jpg" || $tipe_file == "image/jpeg" || $tipe_file == "image/png"){ // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
  ...
  if($ukuran_file <= 1000000){ // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
    ...
    if(move_uploaded_file($tmp_file, $path)){ // Cek apakah gambar berhasil diupload atau tidak
      ...
      $query = "INSERT INTO jenis SET id='$id', kota='$kota', kabupaten='$kabupaten', pusat='$pusat', gambar='$nama_file', keterangan='$keterangan' " or die ("data salah : ".mysqli_error($mysqli));
      ...
      ";
        ...
        echo "<br><a href='dm_kota.php'>Kembali Ke Form</a>";
      }
    }else{
      echo "
      <script>
