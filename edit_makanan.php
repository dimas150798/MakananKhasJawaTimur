<?php
    ...
    $result=mysqli_query($conn, "SELECT * FROM gambar_makanan");
?>
...
<body>
			...
			<div class="ls-slide" data-ls="bgsize:cover; bgposition:50% 50%; duration:4000; transition2d:104; kenburnsscale:1.00;">
				<img src="images/tampil04.jpeg" class="ls-bg" alt="" />
					...
					<div class="slider-content ls-l" style="top:60%; left:30%;" data-ls="offsetyin:100%; offsetxout:-50%; durationin:800; delayin:100; durationout:400; parallaxlevel:0;">
						<a class="btn">Masakan</a>
						<h3 class="title"><b>Khas Di Jawa Timur</b></h3>
						<h6>19 Juni, 2017</h6>
					</div>
   ...
   <table cellspacing="0">
      ...
      <?php $i=1 ?>
        ...
        <tr>
			<td><center><?= $i++ ?></td>
			<td><center><img src="images/<?php echo $row['gambar']?>" width="20%"></td>
            <td><center><?= $row['kota'] ?></td>
            <td><center><?= $row['makanan'] ?></td>
			<td><?= $row['keterangan'] ?></td>
			<td><center><a class ="btn btn-success" href="update_makanan.php?id=<?php echo $row['id'];?>">edit <a class ="btn btn-danger" href="delete_makanansql.php?id=<?php echo $row['id'];?>">delete</a></a></td>
            <td>
        </tr>
            <?php } ?>
	</table>
