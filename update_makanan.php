...
$data = mysqli_query($mysqli, "SELECT * FROM jenis_makanan WHERE id ='$_GET[id]'");
		...
		<div class="wrap-contact100">
			<div class="contact100-form-title" style="background-image: url(images/bg-01.jpg);">
				...
				<span class="contact100-form-title-2">
					<form method="POST" enctype="multipart/form-data" action="update_makanansql.php">				
					Masukkan Makanan Yang Ada Di Jawa Timur 
				</span>
			</div>
			...
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
					...
					<input class="input100" type="text" name="makanan" value="<?php echo $datashow['makanan']; ?>" id="textfield" placeholder="Masukkan nama makanan">
					<span class="focus-input100"></span>
				</div>
